...
top_builddir = .
srcdir  = /home/ANT.AMAZON.COM/bbeckman/Downloads/SDL2-2.0.9
objects = build
gen = gen
prefix = /usr/local
exec_prefix = ${prefix}
...
SHELL	= /bin/bash
CC      = gcc
INCLUDE = -Iinclude -I/home/ANT.AMAZON.COM/bbeckman/Downloads/SDL2-2.0.9/include -idirafter /home/ANT.AMAZON.COM/bbeckman/Downloads/SDL2-2.0.9/src/video/khronos
CFLAGS  = -g -O3 -DUSING_GENERATED_CONFIG_H
EXTRA_CFLAGS = -Iinclude -I/home/ANT.AMAZON.COM/bbeckman/Downloads/SDL2-2.0.9/include -idirafter /home/ANT.AMAZON.COM/bbeckman/Downloads/SDL2-2.0.9/src/video/khronos  -mmmx -m3dnow -msse -msse2 -msse3 -Wall -fvisibility=hidden -Wdeclaration-after-statement -Werror=declaration-after-statement  -D_REENTRANT    -I/usr/include/dbus-1.0 -I/usr/lib/x86_64-linux-gnu/dbus-1.0/include -pthread -I/usr/include/ibus-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include  -D_REENTRANT -DHAVE_LINUX_VERSION_H
LDFLAGS = 
EXTRA_LDFLAGS =  -Wl,--no-undefined -lm -ldl -lsndio -lpthread -lrt
